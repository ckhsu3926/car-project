...
// MaintenanceRepository is an autogenerated mock type for the MaintenanceRepository type
type MaintenanceRepository struct {
	mock.Mock
}

// CreateRecord provides a mock function with given fields: ctx, record
func (_m *MaintenanceRepository) CreateRecord(ctx context.Context, record entities.MaintenanceRecord) error {
...
func (_m *MaintenanceRepository) DeleteRecord(ctx context.Context, recordID uint) error {
...
func (_m *MaintenanceRepository) GetDetailList(ctx context.Context, recordID uint) ([]entities.MaintenanceRecordDetail, error) {
	ret := _m.Called(ctx, recordID)
...
func (_m *MaintenanceRepository) GetRecordList(ctx context.Context, vehicleID uint) ([]entities.MaintenanceRecord, error) {
...
func (_m *MaintenanceRepository) SetDetailList(ctx context.Context, recordID uint, detailList []entities.MaintenanceRecordDetail) error {
...
func (_m *MaintenanceRepository) UpdateRecord(ctx context.Context, record entities.MaintenanceRecord) error {
	ret := _m.Called(ctx, record)
...
type mockConstructorTestingTNewMaintenanceRepository interface {
	mock.TestingT
	Cleanup(func())
}

// NewMaintenanceRepository creates a new instance of MaintenanceRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMaintenanceRepository(t mockConstructorTestingTNewMaintenanceRepository) *MaintenanceRepository {
