...
-- -----------------------------------------------------
-- Table `car-project`.`gas_record`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `car-project`.`gas_record` ;

CREATE TABLE IF NOT EXISTS `car-project`.`gas_record` (
...
-- -----------------------------------------------------
-- Table `car-project`.`repair_record`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `car-project`.`repair_record` ;

CREATE TABLE IF NOT EXISTS `car-project`.`repair_record` (
...
-- -----------------------------------------------------
-- Table `car-project`.`repair_detail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `car-project`.`repair_detail` ;

CREATE TABLE IF NOT EXISTS `car-project`.`repair_detail` (
  `id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '維修項目ID',
  `repair_record_id` MEDIUMINT UNSIGNED NOT NULL COMMENT '維修紀錄ID',
  ...
  PRIMARY KEY (`id`, `repair_record_id`))
ENGINE = InnoDB
COMMENT = '維修項目';
